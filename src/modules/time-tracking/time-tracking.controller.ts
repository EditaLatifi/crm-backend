...
export class TimeTrackingController {
  ...
  @Post('/timer/start')
  async startTimer(@Request() req: any, @Body() body: { accountId: string; taskId?: string; description?: string; projectId?: string; projectPhaseId?: string }) {
    return this.timeTrackingService.startTimer(req.user, body.accountId, body.taskId, body.description, body.projectId, body.projectPhaseId);
  }
